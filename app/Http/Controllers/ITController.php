...
class ITController extends Controller
{
    ...
    function dashboard(Request $request){
        try{ 
            return view('it/dashboard',array('error_message'=>''));
        }catch (\Exception $e){
            CommonHelper::saveException($e,'IT',__FUNCTION__,__FILE__);
            return view('it/dashboard',array('error_message' =>$e->getMessage()));
        }
    }
}
