...
class OperationController extends Controller
{
    ...
    function dashboard(Request $request){
        try{ 
            return view('operation/dashboard',array('error_message'=>''));
        }catch (\Exception $e){
            CommonHelper::saveException($e,'OPERATION',__FUNCTION__,__FILE__);
            return view('operation/dashboard',array('error_message' =>$e->getMessage()));
        }
    }
}
