...
@if(empty($error_message))
    <?php $breadCrumbArray = array(array('name'=>'Dashboard','link'=>'dashboard'),array('name'=>'SOR Purchase Orders','link'=>'purchase-order/product/list'),array('name'=>'Create Purchase Order')); ?>
        ...
        <div class="container-fluid" >
            ...
            <div id="productsContainer">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped clearfix">
                            <thead>
                                ...
                                <tr>
                                    <td style="width:10%;">
                                        <input id="style_name" type="text" class="form-control" name="style_name" value="" autofocus oninput="getStyleData(this.value);" >
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" id="purchase_order_row_add_submit" name="purchase_order_row_add_submit" class="btn btn-dialog" onclick="addPurchaseOrderRow();">Add </button>
                                    </td>
                                </tr>
                            </thead>
                        </table>            
                ...
                <div class="form-group row elem-hidden submit-data-row">
                    ...
                    <div class="col-sm-2">
                        <button type="button" id="create_purchase_order_submit" name="create_purchase_order_submit" class="btn btn-dialog" onclick="createPurchaseOrder();">Submit</button>
