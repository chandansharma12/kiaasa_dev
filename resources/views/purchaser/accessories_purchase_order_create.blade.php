...
@if(empty($error_message))
    <?php $breadCrumbArray = array(array('name'=>'Dashboard','link'=>'dashboard'),array('name'=>'Accessories Purchase Orders','link'=>'purchase-order/accessories/list'),array('name'=>'Create Purchase Order')); ?>
    ...
    <section class="product_area">
        <div class="container-fluid" >
            ...
            <div id="productsContainer">
                        ...
                        <table class="table table-striped clearfix">
                            <thead>
                                <tr>
                                    ...
                                    @endfor
                                    <th>Rate</th><th>Qty</th><th>Amount</th><th></th>
                                </tr>
                                <tr>
                                    <td>
                                        <select class="form-control" name="item_id" id="item_id" onchange="getAccessoriesPOItemData(this.value);">
                                            <option value="">Select Item</option>
                                            @for($i=0;$i<count($accessories_list);$i++)
                                                <option value="{{$accessories_list[$i]->id}}">{{$accessories_list[$i]->accessory_name}}</option>
                                            @endfor
                                        </select>
                                    </td>
                                    ...
                                    @for($i=0;$i<count($size_list);$i++)
                                        <td>
                                            <input id="size_{{$size_list[$i]['id']}}" type="text" class="form-control size-item" name="size_{{$size_list[$i]['id']}}" value="" onkeyup="updateAccessoriesPOTotalQtyCost();">
                                        </td>
                                    @endfor
                                    
                                    <td>
                                        <input id="item_rate" type="text" class="form-control" name="item_rate" value="" readonly="true">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="gst_percent" id="gst_percent" value="">
                                    </td>
                                    <td>
                                        <button type="button" id="purchase_order_row_add_submit" name="purchase_order_row_add_submit" class="btn btn-dialog" onclick="addAccessoriesPurchaseOrderRow();">Add </button>
                                    </td>
                                </tr>
                            </thead>
                        </table>            
                ...
                <div id="purchase_order_accessories_rows_list"></div>
                ...
                <div class="form-group row elem-hidden submit-data-row">
                    ...
                    <div class="col-sm-2">
                        <button type="button" id="create_purchase_order_submit" name="create_purchase_order_submit" class="btn btn-dialog" onclick="createAccessoriesPurchaseOrder();">Submit</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6>Are you sure to delete Item?<br/></h6>
