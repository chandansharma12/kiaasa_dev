...
@if(empty($error_message))
    ...
    <?php $breadCrumbArray = array(array('name'=>'Dashboard','link'=>'dashboard'),array('name'=>'Store Category Sales Report')); ?>
    <?php echo CommonHelper::pageSubHeader($breadCrumbArray,'Store Category Sales Report');$page_name = 'store_category_sales_report'; ?>
        ...
        <div class="container-fluid" >
            ...
            <form method="GET">
                <div class="row justify-content-end" >
                    ...
                    <div class="col-md-2"><a href="{{url('report/store/category/sales?action=download_csv&'.$query_str)}}" class="btn btn-dialog" title="Download Report CSV File"><i title="Download Report CSV File" class="fa fa-download fas-icon" ></i> </a></div>
                </div>
            </form>
