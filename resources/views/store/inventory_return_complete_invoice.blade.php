...
<?php $new_gst_round_demand_id = 2476; ?>
        ...
        <table class="table-1">
            ...
            <tr>
                <td width="50%" valign="top" class="text-1">
                    ...
                    Plot no 1/37 <br/> S.S GT ROAD INDUSTRIAL AREA<br/> LAL KUAN GHAZIABAD - 201002<br/>
    ...
    @if(strtolower($invoice_type) == 'credit_note')
        <table class="table-1 border-top border-bottom" >
            <tr><td width="50%">Credit Note No:&nbsp;{{$demand_data->credit_invoice_no}}<span class="text-3"> </span></td><td width="50%">Credit Note Date:&nbsp;<span class="text-3">{{date('d/m/Y H:i',strtotime($demand_data->created_at))}} </span></td></tr>
        </table>    
    @endif
