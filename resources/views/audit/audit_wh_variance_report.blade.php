        ...
        <div class="container-fluid" >
            ...
            <form method="get">
                <div class="row justify-content-end" >
                    <div class="col-md-2" >
                        <select name="report_type" id="report_type" class="form-control" onchange="updateWHVarianceReportType({{$audit_data->id}},this.value);">
                            ...
                            <?php /* ?><option value="3" @if($report_type_id == 3) selected @endif>QR Code</option> <?php */ ?>
                        </select>
                    </div>
                    <div class="col-md-2" ><a class="btn btn-dialog" href="{{url('audit/inventory/report/variance/wh/'.$audit_data->id.'/'.$report_type_id)}}?action=download_pdf">Download PDF</a></div>
                </div>
            </form>
                                ...
                                <tbody>
                                    ...
                                    @for($i=0;$i<count($category_list);$i++)
                                        <tr>
                                            ...
                                            <td>{{$inv_count_wh = (isset($audit_inventory_wh[$category_list[$i]['id']]->inv_count))?$audit_inventory_wh[$category_list[$i]['id']]->inv_count:0}}</td>
                                            <td>{{$inv_price_wh = (isset($audit_inventory_wh[$category_list[$i]['id']]->inv_price))?$audit_inventory_wh[$category_list[$i]['id']]->inv_price:0}}</td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th>{{$inv_total['inv_count_wh']}}</th>
                                        <th>{{$inv_total['inv_price_wh']}}</th>
                                    </tr>
                                </tbody>
                            </table>
                        @endif
                                ...
                                <tbody>
                                    ...
                                    @for($i=0;$i<count($sku_list);$i++)
                                        <tr>
                                            ...
                                            <td>{{$inv_count_wh = (isset($audit_inventory_wh[$sku_list[$i]['id']]->inv_count))?$audit_inventory_wh[$sku_list[$i]['id']]->inv_count:0}}</td>
                                            <td>{{$inv_price_wh = (isset($audit_inventory_wh[$sku_list[$i]['id']]->inv_price))?$audit_inventory_wh[$sku_list[$i]['id']]->inv_price:0}}</td>
                                        </tr>
                                        <?php $inv_total['inv_count_system']+=$inv_count_system; ?>
                                        <?php $inv_total['inv_price_system']+=$inv_price_system; ?>
                                        <?php $inv_total['inv_count_wh']+=$inv_count_wh; ?>
                                ...
                                <tbody>
                                    ...
                                    @for($i=0;$i<count($barcode_list);$i++)
                                        <tr>
                                            ...
                                            <td>{{$inv_count_wh = (isset($audit_inventory_store[$barcode_list[$i]['id']]->inv_count))?$audit_inventory_store[$barcode_list[$i]['id']]->inv_count:0}}</td>
                                            <td>{{$inv_price_wh = (isset($audit_inventory_store[$barcode_list[$i]['id']]->inv_price))?$audit_inventory_store[$barcode_list[$i]['id']]->inv_price:0}}</td>
                                        </tr>
                                        <?php $inv_total['inv_count_system']+=$inv_count_system; ?>
                                        <?php $inv_total['inv_price_system']+=$inv_price_system; ?>
                                        <?php $inv_total['inv_count_wh']+=$inv_count_wh; ?>
