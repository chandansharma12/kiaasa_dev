                       ...
                       <div class="separator-10"></div>
                            ...
                            <div class="form-row ">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" name="piece_barcode_audit_wh_inv" id="piece_barcode_audit_wh_inv" class="form-control" autofocus="true">
                        ...
                        <div class="form-row" >
                            <button type="button" id="delete_inventory_audit_submit" name="delete_inventory_audit_submit" class="btn btn-dialog" value="Submit" onclick="deleteWHAuditInventoryItems();">Delete</button>&nbsp;&nbsp;
                        </div>
                        <br/>
                        ...
                        <div class="form-row" >
                            ...
                            <button type="button" id ="audit_scan_complete_submit" name="audit_scan_complete_submit" class="btn btn-dialog" value="Submit" onclick="completeWHAuditScan();">Complete Scan</button>&nbsp;&nbsp;
            ...
            <div class="modal-content">
                ...
                <form class="" name="completeAuditScanInventoryForm" id="completeAuditScanInventoryForm" type="POST" >
                    ...
                    <div class="modal-footer center-footer">
                        ...
                        <button type="button" id ="audit_scan_complete_confirm_submit" name="audit_scan_complete_confirm_submit" class="btn btn-dialog" onclick="submitCompleteWHAuditScan();">Submit</button>
                    </div>
                </form>
            </div>
        </div>
