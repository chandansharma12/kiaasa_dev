        ...
        <section class="product_area">
            <div class="container-fluid" >
                <div id="products_import_div" >
                    <form class="" name="auditInventoryScanBulkFrm" id="auditInventoryScanBulkFrm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row" >
                            ...
                            <div class="form-group col-md-2">
                                <button type="button" id ="audit_scan_upload_submit" name="audit_scan_upload_submit" class="btn btn-dialog" value="Submit" onclick="submitScanBulkInventory();">Upload</button>&nbsp;&nbsp;
