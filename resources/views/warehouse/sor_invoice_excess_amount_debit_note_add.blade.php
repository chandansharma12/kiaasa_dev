                                ...
                                <tbody>
                                    ...
                                    @for($i=0;$i<count($sku_list);$i++)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="numeric-text" name="invoice_cost_{{($sku_list[$i]->id)}}" id="invoice_cost_{{($sku_list[$i]->id)}}" onkeyup="updateSorExcessDebitNoteInvoiceAmount(this,{{($sku_list[$i]->id)}},{{$sku_list[$i]->inv_count}},{{$po_amount}});" value="{{isset($sku_data['item_invoice_cost'])?$sku_data['item_invoice_cost']:''}}">
