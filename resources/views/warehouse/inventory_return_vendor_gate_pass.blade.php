...
<table cellpadding="0" id="table_gate_pass" cellspacing="0" >
    ...
    <tr class="border-bottom-tr">
        <?php $vendor_data = json_decode($demand_data->store_data,false); ?>
         <td>Destination: </td><td  style="padding:5px;font-size:12px;">{{$vendor_data->name}}, {{$vendor_data->address}}, {{$vendor_data->city}}-{{$vendor_data->postal_code}}</td>
    </tr>    
